<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Earthmoving-Spares.aspx.cs" Inherits="HelloGES.LeadManagement.Earthmoving_Spares.Earthmoving_Spares" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Want a great deal on Earthmoving Spares? Earthmoving Spares suppliers competing for your business</title>
    <meta name="description" content="Want a great deal on Earthmoving Spares? We'll help you get the best deal on Earthmoving Spares through our network of suppliers." /> 
    ...
    <form id="form1" runat="server">
        <div class="container"> 
            <div class="header bgColor1"> 
                <h1 class="color1">Great deals on Earthmoving Spares</h1> 
            </div> 
            ...
            <div class="contentContainer"> 
                <div class="sidebar1">
                    ...
                    <ul> 
                        <li>earthmoving spares</li>
                        <li>earthmoving equipment spares</li>
                        <li>earthmoving equipment parts</li>
                        <li>earthmoving spare parts</li>
                        <li>earthmoving machinery parts</li>
                        <li>earthmoving machine parts</li>
                    </ul> 
                    <p>&nbsp;</p>
                </div> 
 
                <div class="content"><h2>Looking for a great deal on Earthmoving Spares?</h2> 
                    <p>We figured you'd rather have a Earthmoving Spares supplier chasing you than  having to waste your time phoning people who didn't answer their phones,  or played lousy hold music only to tell you that they didn't have what  you're looking for in stock.</p> 
                    <h2>We get Earthmoving Spares suppliers to compete for your business.</h2> 
                    <p>Fill your details in and we'll pass them on to an <strong>approved and recommended Earthmoving Spares specialist in your area</strong>. They'll call you  with their best offer, exclusive to customers from this website. It's a  100% free, no obligation service . They know you're serious about buying and they know they have to give a great price or we drop them. This  means that you're going to get a good deal from someone who actually wants your business.</p> 
                    ...
                    <div class="pictureHolder">
                        <img alt="Earthmoving Spares" longdesc="Earthmoving Spares" 
                            src="Images/Earthmoving-Spares.jpg" /><br />
                        </div>
                    <div class="clearfloat">
                    </div> 

                    <h2>Here's how we make sure you always get a great deal on Earthmoving Spares.</h2> 
                    <p>We're  deadly serious about making sure you always get a great deal. After  all, we have to uphold our reputation as the best place to buy Earthmoving Spares online .</p> 
                    <ul> 
                        <li>We conduct frequent random price  checks.</li> 
                        <li>We make 'mystery shopper' purchases to make sure that the Earthmoving Spares supplier is giving our customers the best possible deal.</li> 
