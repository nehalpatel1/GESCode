...
public partial class PhotoOptimization_Default : System.Web.UI.Page
{
	...
	protected void Uploader1_FileUploaded(object sender, FileUploadedEventArgs e)
	{
		...
		if (sourceFile != null)
		{
			...
			sourceFile.SaveAs(Path.Combine(gallery.UploadedFilesAbsolutePath, fileName));

			string description = uploadedFile.Description;

			// Add file to the gallery
			gallery.Add(uploadedFile.SourceName, fileName, description);
		}
