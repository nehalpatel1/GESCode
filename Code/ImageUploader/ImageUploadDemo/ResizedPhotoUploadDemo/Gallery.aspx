					...
					<li class="item wide-item">
						...
						<ul class="data">
							<li><a class="fancybox" target="_blank" rel="small" href="<%# ((Dictionary<string, string>)(Container.DataItem))["thumbnailUrl0"] %>">
								small&nbsp;&gt;&gt;</a></li>
							<li><a class="fancybox" target="_blank" rel="medium" href="<%# ((Dictionary<string, string>)(Container.DataItem))["thumbnailUrl1"] %>">
								medium&nbsp;&gt;&gt;</a></li>
							<li><a class="fancybox" target="_blank" rel="large" href="<%# ((Dictionary<string, string>)(Container.DataItem))["thumbnailUrl2"] %>">
								large&nbsp;&gt;&gt;</a></li>
						</ul>
					</li>
				</ItemTemplate>
