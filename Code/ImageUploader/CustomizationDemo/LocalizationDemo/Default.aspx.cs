...
public partial class LocalizationDemo_Default : System.Web.UI.Page
{
	...
	{
		string langStr = e.CommandArgument as string;
		if (!string.IsNullOrEmpty(langStr))
		{
			try
			{
				Language language = (Language)Enum.Parse(typeof(Language), langStr);
				Uploader1.Language = language;
			}
			catch (ArgumentException)
			{
				Uploader1.Language = Language.Default;
			}
		}
	}
