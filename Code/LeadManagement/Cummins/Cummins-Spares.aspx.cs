...
namespace HelloGES.LeadManagement.Cummins
{
    public partial class Cummins_Spares : System.Web.UI.Page
    {
        protected void btnEnquiry_Click(object sender, EventArgs e)
        {
            ...
            using (GESEntities db = new GESEntities())
            {
                try
                {
                    subject = "GES Website Enquiry # " + enquiryID.ToString() + " from the Cummins Spares Lead Page";
