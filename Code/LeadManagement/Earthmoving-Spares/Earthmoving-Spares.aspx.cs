...
namespace HelloGES.LeadManagement.Earthmoving_Spares
{
    public partial class Earthmoving_Spares : System.Web.UI.Page
    {
        protected void btnEnquiry_Click(object sender, EventArgs e)
        {
            ...
            using (GESEntities db = new GESEntities())
            {
                try
                {
                    subject = "GES Website Enquiry # " + enquiryID.ToString() + " from the Earthmoving Spares Lead Page";
