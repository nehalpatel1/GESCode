...
namespace HelloGES.LeadManagement.Google
{
    public class GetRelatedKeywords
    {
        ...
        /// </summary>
        class GetRelatedKeyword : SampleBase
        {
            /// <summary>
            ...
            {
                SampleBase codeExample = new GetRelatedKeyword();
            ...
            public override void Run(AdWordsUser user)
            {
                ...
                TargetingIdeaService targetingIdeaService = (TargetingIdeaService)user.GetService(AdWordsService.v201101.TargetingIdeaService);

                string keywordText = "tlb for sale";
                ...
                selector.requestedAttributeTypes = new AttributeType[] { AttributeType.CRITERION, AttributeType.AVERAGE_TARGETED_MONTHLY_SEARCHES };
                ...
                keywordMatchTypeSearchParameter.keywordMatchTypes = new KeywordMatchType[] { KeywordMatchType.BROAD };

                selector.searchParameters = new SearchParameter[] { relatedToKeywordSearchParameter, keywordMatchTypeSearchParameter };
                        ...
                        foreach (TargetingIdea idea in page.entries)
                        {
                            foreach (Type_AttributeMapEntry entry in idea.data)
                            {
                                if (entry.key == AttributeType.CRITERION)
                                {
                                    ...
                                    Console.WriteLine("Related keyword with text = '{0}' and match type = '{1}' was found.", (kwdAttribute.value as Keyword).text,
