...
namespace HelloGES.LeadManagement.Engine_Parts
{
    public partial class Engine_Parts : System.Web.UI.Page
    {
        protected void btnEnquiry_Click(object sender, EventArgs e)
        {
            ...
            using (GESEntities db = new GESEntities())
            {
                try
                {
                    subject = "GES Website Enquiry # " + enquiryID.ToString() + " from the Engine_Parts Lead Page";
