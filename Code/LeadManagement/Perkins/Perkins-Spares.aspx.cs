...
namespace HelloGES.LeadManagement.Perkins
{
    public partial class Perkins_Spares : System.Web.UI.Page
    {
        protected void btnEnquiry_Click(object sender, EventArgs e)
        {
            ...
            using (GESEntities db = new GESEntities())
            {
                try
                {
                    subject = "GES Website Enquiry # " + enquiryID.ToString() + " from the Perkins Spares Lead Page";
